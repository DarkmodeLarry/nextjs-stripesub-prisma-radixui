...
const interBold = fetch(new URL('../../../assets/fonts/Futura.ttc', import.meta.url)).then((res) =>
  res.arrayBuffer()
)
        ...
        >
          ...
          <div tw='flex items-center w-full justify-between'>
            ...
            >
              ...
              <div tw='flex ml-2'>github.com/darkmodelarry/nextjs-stripesub-prisma-radixui</div>
            </div>
          </div>
        </div>
      ),
